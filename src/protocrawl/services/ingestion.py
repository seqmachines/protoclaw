...
from protocrawl.agents.publisher.tools import publish_protocol
from protocrawl.agents.source_scout.tools import fetch_page_text
...
def _enrich_normalized_protocol(protocol, *, seqspec: SeqSpec, source_text: str, source_url: str):
    ...
    protocol.parser_config = {
        "generator": "protocrawl.agents.parser.tools.extract_seqspec",
        "normalizer": "protocrawl.agents.normalizer.tools.seqspec_to_protocol",
        "schema": "SeqSpec",
